                        ...
                        <div class="mb-3" style="padding-left: 30px;">
                            ...
                            <div class="col-md-4" style="padding-left: 30px;">
                                    <label for="inputState" class="form-label">Origem:</label>
                                        <select name="Origem" class="form-select" style="width: 319%">
                            ...
                            <br>
                                ...
                                <div style="padding-left: 30px;">
                                    <input type="datetime-local" name="Data" style="width: 100%; height: 50px; padding-left: 12px;">
                                </div>
                                <br>
                                    <div style="padding-left: 30px;">
                                        <div class="form-floating">Observação</div>
                                            <textarea class="form-control" placeholder="Insira uma Observação" name="Obs" style="height: 100px"></textarea>
